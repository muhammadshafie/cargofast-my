<template>
  <div class="relative bg-blue-cargo">
    <svg
      class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-blue-cargo bg-red-cargo"
    ...
    >
      <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="flex justify-center items-center text-teal-600 dark:text-teal-300">
          <h1 class="text-xl first-color mr-2 font-bold uppercase">
            {{ item.company_name }}
          </h1>
          <img
            class="h-5 w-auto"
      ...
      <div
        class="flex flex-col justify-center items-center pt-5 pb-10 border-t border-deep-purple-accent-200"
      >
        <p class="text-center text-sm text-gray-100">
          © Copyright 2023 CargoFast (Malaysia) Sdn Bhd. All rights reserved.
        </p>
      </div>
    </div>
  </div>
